...
listaC = [['Blastoise', 'Empoleon', 'Kyogre', 'Swampert'], 
          ['Charizard', 'Typhlosion', 'Blaziken', 'Talonflame'], 
          ['Venusaur', 'Sceptile', 'Torterra', 'Kartana'],
          ['Sandslash', 'Groudon', 'Garchomp', 'Krookodile'],
          ['Pikachu', 'Zapdos', 'Zekrom', 'Luxray']]
...
# Verificando o vencedor
    if ( (userElemento == PcjogadaElemento) or
        ...
        sleep(1)        # Cria um intervalo de tempo antes dos próximos códigos serem ativados
        mostrarCabecalho([f"{listaC[userElemento-1][userPokemon-1]} e {PcjogadaPokemon} se anularam", 'Empate'])       # Mostra a msg de empate
        ...
        mostrarCabecalho([f'{listaC[userElemento-1][userPokemon-1]} ganhou de {PcjogadaPokemon}', 'You WIN'])      # Mostra a msg de que o Usuario ganhou do Pc
       ...
       sleep(1)         # Cria um intervalo de tempo antes dos próximos códigos serem ativados
       mostrarCabecalho([f"{PcjogadaPokemon} ganhou de {listaC[userElemento-1][userPokemon-1]}", 'You Lose'])     # Mostra a msg Pc ganhou do usuario
